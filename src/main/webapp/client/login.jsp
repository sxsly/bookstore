															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username"
																		type="text" class="textinput" value="${requestScope.username}"/>
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left"><input name="password"
																		type="password" class="textinput"  value="${sessionScope.login_user.password}"/>
																	</td>
																</tr>
																<tr>
																	<td colspan="2" style="text-align:center">
																		<c:choose>
																			<c:when test="${requestScope.username != null}">
																				<input
																						type="checkbox" name="checkbox" value="remember" checked/>
																				记住用户名&nbsp;&nbsp;
																			</c:when>
																			<c:otherwise>
																				<input
																						type="checkbox" name="checkbox" value="remember" />
																				记住用户名&nbsp;&nbsp;
																			</c:otherwise>
																		</c:choose>

																		<c:choose>
																			<c:when test="${requestScope.autologin != null}">
																		<input type="checkbox"
																			   name="checkbox" value="autologin" checked/> 自动登录</td>
																			</c:when>
																			<c:otherwise>
																				<input type="checkbox"
																					   name="checkbox" value="autologin" /> 自动登录</td>
																			</c:otherwise>
																		</c:choose>
