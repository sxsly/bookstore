...
<script>
	function changeProductNum(count, totalCount, id) {
		...
		location.href = "${pageContext.request.contextPath}/product/changeCart.do?id="
				+ id + "&count=" + count;
	}
	
	function checkMaxnum(id,totalCount) {
									...
									<tr>
										<td>
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="20%">
															...
															<input id="count1" type="text" value="${entry.value}" style="width:40px;text-align:center" onkeyup="checkMaxnum(${entry.key.id},${entry.key.pnum})"/>
															<input type="button" value='+' style="width:20px"
															onclick="changeProductNum('${entry.value+1}','${entry.key.pnum}','${entry.key.id}')">
														...
														<td width="10%">
															<a href="${pageContext.request.contextPath}/product/changeCart.do?id=${entry.key.id}&count=0"
											...
											<div style="text-align:right; margin-top:10px">
												<a href="${pageContext.request.contextPath}/product/findProductInfo.do">
