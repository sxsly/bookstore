...
<script type="text/javascript">
	function modifyForm() {
		$.post("${pageContext.request.contextPath}/user/modifyUserInfo.do",
			...
			<tr>
				...
				<td>
					<div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/aliindex.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;
							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td colspan="2">
											<input name="telphone" type="text" value="${login_user.telphone}" class="textinput" />
										</td>
									</tr>
									<tr>
								...
								<p style="text-align:center">
									...
									<%--</a>--%>
									<input type="button" style="width:158px; height:33px; cursor:pointer; background-image: url('${pageContext.request.contextPath}/client/images/botton_gif_025.gif')" onclick="modifyForm()"/>
								</p>
