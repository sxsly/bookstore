					...
					<table width="100%" border="0" cellspacing="0">
						...
						<c:forEach items="${pList }" var="pArray">
							<td style="width:80; text-align:center">
								<a href="${pageContext.request.contextPath}/product/findProductById.do?id=${pArray.id}">
									<img src="${pageContext.request.contextPath }${pArray.imgurl}" width="102" height="130" border="0" />
								</a>
								<br /> 
								<a href="${pageContext.request.contextPath}/product/findProductById.do?id=${pArray.id}">${pArray.name}</a>
								 <%--<br />书名:${pArray.name }--%>
							</td>
						</c:forEach>
						</tr>
