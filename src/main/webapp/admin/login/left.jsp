...
<div class="dtree">
  ...
  <tr>
  	<td><a href="${pageContext.request.contextPath}/productManage/findProductByManyCondition.do" target="mainFrame" class="left_list">商品管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/products/download.jsp" target="mainFrame" class="left_list">销售榜单</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/orderManage/findAllOrders.do" target="mainFrame" class="left_list">订单管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/noticeManage/findNotices.do" target="mainFrame" class="left_list">公告管理</a></td>
  </tr>
</table>
</body>
</html>
