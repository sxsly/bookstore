								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/admin/images/loginbg.gif">
											<form id="loginAction_home" name="form1" action="${pageContext.request.contextPath}/user/adminLogin.do" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<input type="text" name="username" value="${admin_user.username}" id="username" class="text" style="width: 160px;"/>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
													...
													<tr>
														<td height="30" nowrap colspan="2">
															<strong><font color="red">${errMsg}</font> </strong>
														</td>
													</tr>
													<tr>
														<td height="30">
