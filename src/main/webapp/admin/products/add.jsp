...
<script type="text/javascript">
    <%--function addP() {--%>
        ...
        <%--$.ajax({--%>
            <%--url: "${pageContext.request.contextPath}/productManage/addProduct.do",--%>
            <%--type: "POST",--%>
            <%--data: fd,--%>
            <%--processData: false,--%>
...
<body>
	<form id="addProductForm" name="Form1" action="${pageContext.request.contextPath}/productManage/addProduct.do" method="post"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<input
					type="file" name="upload" id="file" size="30" value=""/>
				</td>
			</tr>
			<TR>
