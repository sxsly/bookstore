...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=tradequery action=${pageContext.request.contextPath}/alipay.trade.query.jsp method=post
			target="_blank">
		...
		<form name=traderefund action=${pageContext.request.contextPath}/alipay.trade.refund.jsp method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=${pageContext.request.contextPath}/alipay.trade.fastpay.refund.query.jsp method=post
			target="_blank">
		...
		<form name=tradeclose action=${pageContext.request.contextPath}/alipay.trade.close.jsp method=post
			target="_blank">
